...
typedef enum hipError_t { hipSuccess = 0, hipErrorOutOfMemory = 2 } hipError_t;
enum hipMemcpyKind { hipMemcpyHostToDevice=2, hipMemcpyDefault = 4 };
...
typedef struct ext_funcs {
    ...
    hipError_t (*hipMemcpy)(void *, const void *, size_t, enum hipMemcpyKind);
    hipError_t (*hipDeviceSynchronize)(void);
    hipError_t (*hipHostAlloc)(void **, size_t, unsigned int);
    hipError_t (*hipHostFree)(void *);
    hipError_t (*hipDeviceGetPCIBusId)(char *, int, int);
    hipError_t (*cudaDeviceMalloc)(void **, size_t);
    hipError_t (*cudaDeviceFree)(void *);
